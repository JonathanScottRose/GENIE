      ...
      if(line[0] != ' ') {
        ...
        case MPSROWS:
          ...
          if(strcmp(field1, "N") == 0) {
            ...
            if ((!str_add_constraint(lp, "" ,LPS_LE ,0)) || (!set_row_name(lp, lp->rows, field2)))
              break;
          }
          else if(strcmp(field1, "G") == 0) {
            if ((!str_add_constraint(lp, "" ,LPS_GE ,0)) || (!set_row_name(lp, lp->rows, field2)))
              break;
          }
          else if(strcmp(field1, "E") == 0) {
            if ((!str_add_constraint(lp, "",LPS_EQ ,0)) || (!set_row_name(lp, lp->rows, field2)))
              break;
          }
          else {
