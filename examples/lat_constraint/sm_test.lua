...
b:system('sm_test', make_topo_xbar(true, true, true))
	...
	local link_a = b:link('the_dispatch.out.unit_a', 'the_inverter.in')
	local link_b = b:link('the_dispatch.out.unit_b', 'the_reverser.in')
	local link_c = b:link('the_inverter.out', 'xorro.in.in0')
	local link_d = b:link('the_reverser.out', 'xorro.in.in1')
